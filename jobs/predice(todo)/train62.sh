...
srun python -u main_fineturn_x.py --output_dir ~/result/space \
 ...
 --depth 2  \
 --patch_size 6 9 --drop_path 0.1 --no-interp --token -5 --log --norm std --l4w 0.01 --meta_pose --meta_feature --drop_fluxe 1 2 4 --geo --input_geo --old_geo_input \
 --predict 24 \
 --ckpt_name test123 \
...
srun python -u main_fineturn_x.py --output_dir ~/result/space \
 ...
 --embed_dim 256 --latent_dim 256 --input_size 72 \
 --depth 2  \
 --patch_size 6 9 --drop_path 0.1 --no-interp --token -5 --log --norm std --l4w 0.01 --no-meta_pose --no-meta_feature --drop_fluxe 1 2 3 4 --geo --input_geo --old_geo_input \
 --predict 24 \
 --ckpt_name test124 \
